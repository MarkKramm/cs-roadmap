...
w();
w("That leaves **370 claims** that genuinely need an external source.");
w();
w("Two classes need no external source at all, which makes them the strongest tier:");
w();
w("- **Stated counts and arithmetic** — recompute from the document's own numbers.");
w("- **Subnetting** — RFC 1918 fixes the private ranges; everything else is arithmetic.");
w();
