...
# This bundle covers 4 claim classes, 64 rows total.
...
<!-- 03-protocol-and-standard-behaviour.md — 26 rows -->
...
<!-- 04-product-versions-and-editions.md — 17 rows -->
...
<!-- 05-registry-paths-file-paths-and-filenames.md — 17 rows -->
